...
<template>
  <div class="shopcart" tabindex="0" @blur="listShow = false">
    <!-- 购物车 -->
    <div class="content">
      <!-- 主要内容 -->
      <div id="shopcart-main-content" class="main-content" @click="toggleList">
        <div class="left">
          ...
          <div class="price" :class="{ priceLight: totalCount > 0 }"  v-show="listShow">Total: $ {{ totalPrice }}</div>
      ...
      <transition name="fold">
          <div class="shopcart-list"  v-show="listShow">
            <div class="list-header">
              <span class="hide-shop-cart" @click="toggleList">[ - ]</span>
              <span class="title" @click="toggleList">{{ $t("message.shopcarts.shopcart") }}</span>
...
export default {
  ...
  methods: {
    ...
    toggleList() {
      ...
      let ele = document.getElementById("shopcart-main-content")
      if( this.listShow) {
