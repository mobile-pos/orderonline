  ...
  <div class="restaurant-pc-viewer">
    <div class="head" style="position: absolute; width:100%; height: 90px;" ref="headRef">
      <restaurant-header v-model="restaurant" 
              style="position: absolute; left: 30%; width: 40%" :rid="rid" :uuid="uuid" 
              :term="0"
              @change="isOnline"
              />
      ...
      <span class="current-consumer-info" >
    ...
    <div class="order-control">
      <!-- <div style="position:fixed;  left: 30px; bottom: 0px;text-align: center;" @click="gotoOrders">
        <img src="/static/img/order_selected.png" style="width: 20px;height: 15px;">
        <div style="font-size:12px;color:rgb(114, 111, 111); text-align:center;">orders</div>
      </div> -->
      <div style="position:fixed;  left: 30px; bottom: 0px;text-align: center;" >
      </div>
    </div>
    <!-- 左右联动 -->
                      ...
                      <div class="content">
                        ...
                        <template  v-if="restaurant.online">
                            <div v-if="food.rest != 0" class="control-area" >
                              ...
                              <template v-else>
                                <span class="modify-flavors" @click="onShowFoodViewer(food, $event)">modify</span>
...
<!-- 
    <dlg-modal :is-show="showFalvors" :top-distance="10" @on-close="onClose" style="z-index:1000"
        :widNum="40"
        :leftSite="30">
...
import Shopcart from "./shopcart-for-pc-scan";
